...
// Copyright (c) 2020, BitcoinPhantom Developers
...
namespace WalletConfig
{
    ...
    const std::string_view addressPrefix = "BTCXP";

    /* Your coins 'Ticker', e.g. Monero = XMR, Bitcoin = BTC */
    const std::string ticker = "BTCXP";
    ...
    const std::string daemonName = "BitcoinPhantomd";
    ...
    /* The name of service/walletd, the programmatic rpc interface to a
       wallet */
    const std::string walletdName = "bitcoinphantomcurrency-service";

    /* The full name of your crypto */
    const std::string coinName = std::string(CryptoNote::CRYPTONOTE_NAME);

    /* Where can your users contact you for support? E.g. discord */
    const std::string contactLink = "https://t.me/bitcoinphantom";// telegram support group
